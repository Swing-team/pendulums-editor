...
(function () {
    ...
    var applyWordGrab = function (editor, rng) {
      var r = ExpandRange.expandRng(editor, rng, [{ inline: true }], false);
    ...
    var annotateWithBookmark = function (editor, name$$1, settings, data) {
      editor.undoManager.transact(function () {
        ...
        var bookmark = GetBookmark.getPersistentBookmark(editor.selection, true);
        var rng = editor.selection.getRng();
    ...
    var isPaddingContents = function (elm) {
      return isText(elm) ? get$5(elm) === '\xA0' : isBr(elm);
    };
    ...
    var NormalizeRange = { normalize: normalize$1 };
